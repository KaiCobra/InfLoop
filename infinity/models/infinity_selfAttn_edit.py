"""Infinity Transformer 模型：selfAttn-Edit 版（infinity_selfAttn_edit）

功能說明
=========
在 infinity_p2p_edit.py 的基礎上使用 **self-attention 引導的空間遮罩機制**，
專為「局部文字內容替換」場景設計。

使用方式
--------
    from infinity.models.infinity_selfAttn_edit import Infinity
    # 完整範例請參考 tools/run_selfAttn_edit.py
"""
