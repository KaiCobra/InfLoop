\begin{table*}[t]
\centering
\caption{Comparison of different editing methods. Darker color indicates better performance.}
\label{tab:method_comparison_wo_kvedit}
\resizebox{\textwidth}{!}{%
\begin{tabular}{l l c c c c c c c c c}
\toprule
Method & Base Model & Param. & S.D.$\downarrow$ & PSNR$\uparrow$ & SSIM$\uparrow$ & LPIPS$\downarrow$ & CLIP whole$\uparrow$ & CLIP edited$\uparrow$ & Resolution & Inf. Time$\downarrow$\\
\midrule
